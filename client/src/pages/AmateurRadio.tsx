...
import linkBudget from "../assets/client/AmateurRadio/Link_Budget.pdf";
import transmissionPlan from "../assets/client/AmateurRadio/Transmission Plan.pdf";
import powerBudget from "../assets/client/AmateurRadio/Power Budget.pdf";
import cad from "../assets/client/AmateurRadio/CAD_Drawing.pdf";
...
const DOCUMENTS: Document[] = [
  ...
  },
  {
    ...
    title: "Power Budget",
    description:
      "Comprehensive power budget analysis for the satellite platform.",
    icon: <PowerBudgetIcon />,
    downloadUrl: powerBudget,
  },
  {
    id: "cad",
    title: "CAD",
    description: "Detailed CAD for the satellite platform.",
    icon: <CadIcon />,
    downloadUrl: cad,
  },
];
...
export function PowerBudgetIcon() {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function CadIcon() {
  return (
    ...
    >
      ...
      <path d="M2 17V7l10 5v10Z" />
      <path d="m22 7-10 5v10l10-5Z" />

      {/* Technical Vertex Editing Nodes */}
    ...
    <div className="w-full bg-[#ebe9e3] min-h-screen lg:mt-35  mt-22 ">
      ...
      <section className="w-full max-w-400 mx-auto px-6 sm:px-8 lg:px-12 pb-30 relative">
        ...
        <header className="mb-8 sm:mb-10">
          ...
          <p className="text-[11px] lg:text-[12px] uppercase tracking-[0.14em] text-black/45 mb-3">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 ">
          {DOCUMENTS.map((doc) => (
            ...
            <div
              key={doc.id}
              className="p-8 sm:p-10 border-black/20 lg:odd:border-r hover:bg-black/[0.025] even:bg-black/3  lg:even:bg-transparent
                          lg:[&:nth-last-child(n+3)]:border-b 
                        "
            >
              {/* draw border-b for every card except the last two */}
              {/* Icon */}
              <div className="mb-6 flex justify-center">
                <div className=" p-5 rounded-2xl group-hover:bg-[#e8e8ff] transition-colors duration-300 text-[#C18374]">
                  {doc.icon}
              ...
              {/* Title */}
              <h3 className="text-[20px] lg:text-2xl xl:text-3xl font-semibold text-[#1a1a18] text-center mb-3 playfairDisplayDiv ">
                {doc.title}
              </h3>

              {/* Description */}
              <p className="text-base xl:text-lg leading-[1.6] text-black/65 text-center mb-6">
                {doc.description}
              </p>
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="inline-flex items-center justify-center  bg-[#2F5064] playfairDisplayDiv hover:bg-[#183148] text-white font-semibold xl:py-2.5 py-1.5 xl:px-8 px-6 rounded-lg transition-all duration-300 gap-2 group/btn"
                >
                  View
                </a>
              </div>
