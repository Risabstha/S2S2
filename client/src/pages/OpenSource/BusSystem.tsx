...
import { busSystemITEMS } from "../../assets/Data/BusDetails";
...
export default function BusSystem() {
  ...
  const onScroll = () => {
    ...
    const cardWidth = el.scrollWidth / busSystemITEMS.length;
    const idx = Math.round(el.scrollLeft / cardWidth);
    setActiveIndex(Math.min(idx, busSystemITEMS.length - 1));
  };
      ...
      <section className="w-full max-w-400 mx-auto px-6 sm:px-8 lg:px-12 lg:mt-35 mt-22">
        <header className="mb-8 sm:mb-18">
          ...
          <p className="text-[12px] uppercase tracking-[0.14em] text-black/45 mb-3">
            Explore our spacecraft bus system components with technical
